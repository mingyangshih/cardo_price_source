<template lang="pug">
  nav.container-fluid.nav.d-flex.align-items-center
    div( @click="activeNav = '票券庫存查詢'")
...
<style lang="scss" scoped>
  .nav{
    background: transparent linear-gradient(89deg, #1B79F4 0%, #27489A 53%, #3B44A9 100%) 0% 0%;
